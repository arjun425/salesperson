...
const ScanSellPage = ()=>{
            ...
            __turbopack_context__.r("[project]/node_modules/quagga/lib/quagga.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i).then((module)=>{
                ...
                QuaggaModule.onDetected(async (result)=>{
                    ...
                    if (!scanned) {
                        ...
                        setScanned(true);
                        QuaggaModule.stop();
                        // Look up product from Firestore using the barcode
    ...
    const handleConfirmSell = async ()=>{
        if (!barcode || sellQuantity <= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please enter a valid quantity to sell!");
            return;
        }
        try {
            const productsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firebaseConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "inventory");
            ...
            querySnapshot.forEach(async (docSnapshot)=>{
                if (docSnapshot && typeof docSnapshot.data === "function") {
                    const data = docSnapshot.data();
                    if (data && data.barcode === barcode) {
                        productFound = true;
                        const currentQty = data.quantity || 0;
                        const sellQty = Number(sellQuantity);
                        if (sellQty > currentQty) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Cannot sell more than available stock!");
                            return;
                        }
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDoc"])(docSnapshot.ref, {
                            quantity: currentQty - sellQty
                        });
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Product sold successfully!");
                    }
                }
            });
            if (!productFound) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ea9cc5a4._.js.map